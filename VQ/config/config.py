...
config.cl = edict()
config.cl.name = 'ewc'
config.cl.memory_size = 0
config.cl.pkl_file = './data/ego4d_vq_query_incremental_5.pkl'
config.cl.random_order = False
config.cl.reg_lambda = 3000
config.cl.type_sampling = 'icarl'
config.cl.path_memory = None
config.cl.adv_lambda = 0
config.cl.prompt_pool =  False
config.cl.pool_size = 10
config.cl.topk = 4
config.cl.length = 20
config.cl.embed_dim = 768
config.cl.narration_ssl = False
config.cl.narration_dim = 512
config.cl.ssl_factor = 0.03
config.cl.use_adapt = False
config.cl.adapt_blocks = [0,1,2,3,4]
config.cl.use_narration = False
config.cl.narration_feat_folder = None
