...
if __name__ == "__main__":
    ...
    parser.add_argument("--gt-file", required=False, type=str, default='./VQ2D/data/vq_val.json')
    parser.add_argument("--pred-file", required=False, type=str, default='evaluate/inference_cache_val_results.json.gz')
